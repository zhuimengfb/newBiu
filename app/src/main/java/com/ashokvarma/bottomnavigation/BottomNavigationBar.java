...
public class BottomNavigationBar extends FrameLayout {
  ...
  public void showBadgeNumber(int position, String text) {
    mBottomNavigationTabs.get(position).setBadgeNumber(text);
  }

  public void hideBadge(int position) {
    mBottomNavigationTabs.get(position).hideBadge();
  }
  public void showCircleBadge(int position) {
    mBottomNavigationTabs.get(position).showCircleBadge();
  }

  public void setDragDismissDelegate(int position, BGADragDismissDelegate delegate) {
    mBottomNavigationTabs.get(position).setDragDismissDelegate(delegate);
  }

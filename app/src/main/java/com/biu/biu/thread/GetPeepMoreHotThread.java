 ...
 *
 */
public class GetPeepMoreHotThread extends Thread{
	...
	public GetPeepMoreHotThread(Handler handler, int nGetted, String id){
	...
	public void run() {
		...
		String nextpageurl = "http://api.bbbiu.com:1234/topic/" + mTopicId + "/hotTopicThread" +
		"?device_id=" + UserConfigParams.device_id + "&limit=5&offset=" + mGettedCount; 
